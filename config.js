...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~OAkyRYJI#D9hyK9r1rQvpU5KsJg7XIvIewA7pQWLyRQfd7hcyHNw"
    PREFIX: process.env.PREFIX || getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2250586358598",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("Chris_MD") || "",           // Owner's name
